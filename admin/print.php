...
<table class="table" id = "tables">
    ...
    $sql = "select * from LMS.record order by Time DESC LIMIT $start_from, $record_per_page";
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        ...
        ?>
                                    <tr>
                                      <td><?php echo strtoupper($rlno) ?></td>
                                      <td><?php echo $BookId ?></td>
                                      <td><b><?php echo $Date_of_Issue ?></b></td>
    ...
    $sql = "select * from LMS.record order by Time DESC";
...
<br>
<br>
                        <input type="button" value="print record" id="btn_print" class="btn btn-primary">
    ...
    <script>
        $('#btn_print').click(function(){
            ...
            let print = document.getElementById('tables');
            let wprint = window.open("","","width=100%, height=auto");
            wprint.document.write(print.outerHTML);
