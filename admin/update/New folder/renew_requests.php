...
<html lang="en">
    ...
    <div class="navbar navbar-fixed-top">
            <div class="navbar-inner" style="background-color:#202124">
                <div class="container">
                    <img src="images/icons8_library_50px_2.png" width="40" style="position:absolute;margin-left:-40px;margin-top:10px;"/>
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">LMS </a>
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav pull-right">
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="images/icons8_user_male_skin_type_6_50px.png" class="nav-avatar" />
                                <b class="caret"></b></a>
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
if ($renewals > 0) {echo "<a href=\"acceptrenewal.php?id1=" . $bookid . "&id2=" . $rollno . "\" class=\"btn btn-success\">Accept</a>";}
        ?>
        ...
        <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2021 Library Management System__Capstone Project CIU</b>All rights reserved.
            </div>
        </div>
