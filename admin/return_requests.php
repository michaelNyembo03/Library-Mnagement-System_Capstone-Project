...
$rollno = $_SESSION['RollNo'];
    ...
    $sql = "select return.BookId,return.RollNo,Title,curdate()-Due_Date as x from LMS.return,LMS.book,LMS.record where return.BookId=book.BookId and return.BookId=record.BookId and return.RollNo=record.RollNo order by BookId DESC LIMIT $start_from, $record_per_page";
    $result = $conn->query($sql);
...
if ($dues > 0) {
    ...
    $sql = "select return.BookId,return.RollNo,Title,curdate()-Due_Date as x from LMS.return,LMS.book,LMS.record where return.BookId=book.BookId and return.BookId=record.BookId and return.RollNo=record.RollNo";
    ...
    for ($i = 1; $i <= $total_pages; $i++) {
        echo "<a href='issue_requests.php.php?page=" . $i . "'>" . $i . " " . "</a>";
    }
