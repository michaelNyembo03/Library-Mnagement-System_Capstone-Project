    ...
    <div class="container-main">
      <section class="nav">
        <div class="menu-btn">
          ...
          <!-- <p><?//php echo date('Y-m-d'); ?><span><?//php echo " _ " . date("h:i A"); ?><span></p> -->
      ...
      <?Php
$rollno = $_SESSION['RollNo'];
    $sql = "select SUM(Availability) AS sum from LMS.book";
...
<?php
$rollno = $_SESSION['RollNo'];
    $sql1 = "select COUNT(Type) AS sum from LMS.user WHERE Type='Student'";
...
<?php
$rollno = $_SESSION['RollNo'];
    $sql2 = "select COUNT(*) As sum from LMS.record WHERE Date_of_Return is null ";
...
<?php
$rollno = $_SESSION['RollNo'];
    $sql3 = "select COUNT(*) As sum from LMS.record WHERE Date_of_Return is null and curdate() > Due_Date";
           ...
           <div class="dashboard">
            <div class="container-dashboard">
              <div class="box b_one">
                ...
                <p>Book: <span><?php echo $sum; ?></span></p>
              </div>
              <div class="box b_two">
                <i class="fa fa-thumbs-up" aria-hidden="true"></i>
                <p>Currently Issued: <span><?php echo $sum2; ?></span></p>
              </div>
              <div class="box b_three">
                <i class="fa fa-thumbs-down" aria-hidden="true"></i>
                <p>Book not Returned: <span><?php echo $sum3; ?></span></p>
              </div>
              <div class="box b_four">
                <i class="fa fa-users" aria-hidden="true"></i>
                <p>Student: <span><?php echo $sum1; ?></span></p>
