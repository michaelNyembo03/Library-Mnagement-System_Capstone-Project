...
$record_per_page = 10;
    ...
    $sql = "select * from LMS.recommendations order by R_ID desc limit $start_from, $record_per_page";
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        ...
        ?>
                                    <tr>
                                      ...
                                      <td><b><?php echo strtoupper($rolln) ?></b></td>
                                      <td><a href="deleteRec.php?id=<?php echo $rid; ?>" class="btnd btn btn-danger">Delete</a></td>
