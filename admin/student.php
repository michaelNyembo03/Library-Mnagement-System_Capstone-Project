...
$rollno = $_SESSION['RollNo'];
    ...
    if (isset($_POST['submit'])) {$s = $_POST['title'];
        ...
        $sql = "select * from LMS.user where RollNo<>'ADMIN' order by RollNo DESC LIMIT $start_from, $record_per_page";
    }
            ...
            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>
                                        ...
                                        <a href="edit_student.php?id=<?php echo $rollno; ?>" class="btn btn-success">Edit</a>
                                        <a href="remove_student.php?id=<?php echo $rollno; ?>" class="btn btn-danger">Delete</a>
                                      </center>
                                        </td>
                                    </tr>
                            <?php }}?>
