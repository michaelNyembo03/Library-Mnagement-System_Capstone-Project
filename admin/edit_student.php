...
<br >
                                    <form class="form-horizontal row-fluid" action="edit_student.php?id=<?php echo $rno ?>" method="post">
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="RollNo">RollNo:</label></b>
                                            <div class="controls">
                                                <input type="text" id="RollNo" name="RollNo" value= "<?php echo $rno ?>" class="span8" required>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Name">Name:</label></b>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name = "Category" tabindex="1" value="ENG" data-placeholder="Select Category" class="span6">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="MobNum">Mobile Number:</label></b>
                                            <div class="controls">
                                                <input type="text" id="MobNum" name="MobNum" value= "<?php echo $mobno ?>" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <b>
                                            ...
                                            <div class="controls">
                                                <input type="text" id="password" name="password" value= "<?php echo $pass ?>" class="span8" required>
                                            </div>
                                        </div>
...
if (isset($_POST['submit'])) {
        ...
        $sql1 = "update LMS.user set Name='$name', Department='$category', EmailID='$email', MobNo='$mobno', Password='$pass' where RollNo='$userid'";
