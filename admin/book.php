...
$rollno = $_SESSION['RollNo'];
    ...
    if (isset($_POST['submit'])) {
        $s = $_POST['title'];
        $sql = "select * from LMS.book where BookId='$s' or Title like '%$s%' order by Availability DESC";
    } else {
        $sql = "select * from LMS.book order by Availability DESC LIMIT $start_from, $record_per_page";
    }
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            ?>
                                    <tr>
                                      ...
                                      <td><b><?php echo $avail ?></b></td>
                                        <td><center>
                                            ...
                                            <a href="del_book.php?id=<?php echo $bookid; ?>" class="btn btn-danger">Delete</a>
                               ...
                               <?php }}?>
                                ...
                                <a href="addbook.php?id=<?php echo $bookid; ?>" class="btn btn-primary">Add new book</a>
                                <br>
                                <br>
                                <?php
