    ...
    <div class="container-main">
      ...
      <div class="span9">
                        <table class="table" id = "tables">
                                  <thead>
                                    <tr>
                                      <th>Bug or suggestion</th>
                                      <th>Bug Reported od Suggestion Given By</th>
                                      <th></th>
                                    </tr>
                                  </thead>
                                  <tbody>
...
$record_per_page = 10;
    ...
    $sql = "select * from LMS.reportBug order by R_ID desc limit $start_from, $record_per_page";
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        ...
        ?>
                                    <tr>
                                      ...
                                      <td><a href="deleteReportBug.php?id=<?php echo $rid; ?>" class="btnd btn btn-danger">Delete</a></td>
