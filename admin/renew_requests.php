...
$rollno = $_SESSION['RollNo'];
    ...
    $sql = "select * from LMS.record,LMS.book,LMS.renew where renew.BookId=book.BookId and renew.RollNo=record.RollNo and renew.BookId=record.BookId order by Time DESC LIMIT $start_from, $record_per_page";
    $result = $conn->query($sql);
