                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Report a bug or Give Suggestion</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="rePORTbUG.php" method="post">
...
if (isset($_POST['submit'])) {
        ...
        $sql1 = "insert into LMS.reportBug (Description,RollNo) values ('$Description','$rollno')";
