...
$rollno = $_SESSION['RollNo'];
    ...
    $sql = "select * from LMS.message where RollNo='$rollno' order by Date DESC,Time DESC LIMIT $start_from, $record_per_page";
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
        ...
        ?>
                                    <tr>
                                      ...
                                      <td><?php echo $date ?></td>
                                      <td><?php echo $time ?></td>
                                      <td style="text-align:center"><a href="deleteMessage.php?id=<?php echo $mid; ?>" class="btnd btn btn-danger">Delete</a></td>
                                    </tr>
                               <?php }?>
                               </tbody>
                                </table>
